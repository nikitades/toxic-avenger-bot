 ...
 */
final class Version20211011195050 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE bad_word_library_record (id UUID NOT NULL, telegram_chat_id INT NOT NULL, text TEXT NOT NULL, active BOOLEAN NOT NULL, added_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE bad_word_usage_record (id UUID NOT NULL, user_id TEXT DEFAULT NULL, telegram_message_id INT NOT NULL, telegram_chat_id INT NOT NULL, library_word_id UUID NOT NULL, sent_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE bot_user (id TEXT NOT NULL, telegram_id INT NOT NULL, name TEXT NOT NULL, added_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, bad_words_used INT NOT NULL, PRIMARY KEY(id))');
